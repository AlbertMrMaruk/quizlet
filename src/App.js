...
function App() {
  ...
  return (
    <div className="w-full bg-[#0a092d] h-[100vh]">
      ...
      {cards.map((el, index) => (
        <div
          className={`bg-[#2e3856]  rounded-lg md:w-[70%] m-auto my-8 md:my-5 p-0 md:h-[70vh] min-h-[39vh] w-[95%] ${
        ...
        >
          <div
            className={`w-[100%] md:h-[100%] h-[39vh] p-2 ${
          ...
          <div
            className={`w-[100%] p-5 m-auto text-white font-bold  text-sm  md:text-3xl md:py-[4rem] md:px-[2rem] md:text-center h-[39vh] md:h-[100%] ${
              currentCard.id === index && currentCard.expand
                ? "flex items-center"
                : "hidden"
            }`}
